...
export default function App() {
  ...
  function toggleDirective(id: string) {
    setDirectives((prev) => {
      ...
      setTimeout(() => {
        playSound(
          completedNow ? "/sounds/rank-rise.mp3" : "/sounds/rank-up.mp3",
          0.45,
          false
        );
      }, 0);
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(20,70,140,0.18),_transparent_25%),linear-gradient(180deg,#010611_0%,#020a1a_45%,#020611_100%)] text-slate-100">
